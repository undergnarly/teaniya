...
const teas: TeaProduct[] = [
  {
    ...
    origin: "Uji, Japan",
    description: "Shade-grown for 21 days. Deep umami, sweet marine notes, lingering finish.",
    price: "IDR 280,000",
    weight: "50g",
    category: "green",
    image: "/images/tea-gyokuro.jpg",
    tags: ["Shade-grown", "Umami"],
  },
  {
    id: "longjing",
    name: "Dragon Well",
    origin: "Hangzhou, China",
    description: "Pre-Qingming harvest. Chestnut sweetness with a clean, vegetal character.",
    price: "IDR 320,000",
    weight: "50g",
    category: "green",
    image: "/images/tea-longjing.jpg",
    tags: ["Spring Harvest", "Classic"],
  },
  {
    id: "tieguanyin",
    name: "Tie Guan Yin",
    origin: "Anxi, Fujian",
    description: "Traditional charcoal-roasted. Orchid fragrance with toasted grain depth.",
    price: "IDR 260,000",
    weight: "50g",
    category: "oolong",
    image: "/images/tea-tieguanyin.jpg",
    tags: ["Roasted", "Floral"],
  },
  {
    id: "dahongpao",
    ...
    description: "The legendary rock tea. Mineral, cinnamon bark, dark chocolate complexity.",
    price: "IDR 450,000",
    weight: "30g",
    category: "oolong",
    image: "/images/tea-dahongpao.jpg",
    tags: ["Rock Tea", "Rare"],
  },
  {
    id: "alishan",
    ...
    description: "Grown at 1,400m. Buttery, floral, with notes of lily and cream.",
    price: "IDR 340,000",
    weight: "50g",
    category: "oolong",
    image: "/images/tea-alishan.jpg",
    tags: ["High Mountain", "Creamy"],
  },
  {
    id: "sheng-puerh",
    name: "Ancient Tree Sheng",
    origin: "Yiwu, Yunnan",
    description: "2018 vintage from 300-year-old trees. Honey, stone fruit, evolving complexity.",
    price: "IDR 580,000",
    weight: "100g cake",
    category: "pu-erh",
    image: "/images/tea-sheng.jpg",
    tags: ["Aged", "Ancient Tree"],
  },
  {
    id: "shou-puerh",
    name: "Palace Grade Shou",
    origin: "Menghai, Yunnan",
    description: "12 years aged. Smooth, earthy, with dark cocoa and dried date sweetness.",
    price: "IDR 420,000",
    weight: "100g cake",
    category: "pu-erh",
    image: "/images/tea-shou.jpg",
    tags: ["Aged 12 Years", "Smooth"],
  },
  {
    id: "silver-needle",
    name: "Silver Needle",
    origin: "Fuding, Fujian",
    description: "Pure buds, sun-dried. Delicate honeydew melon and white flower whisper.",
    price: "IDR 380,000",
    weight: "30g",
    category: "white",
    image: "/images/tea-silver-needle.jpg",
    tags: ["Bud Only", "Delicate"],
  },
  {
    id: "lapsang",
    name: "Lapsang Souchong",
    origin: "Wuyi, Fujian",
    description: "Pine-smoked over longan wood. Campfire, dried longan, subtle sweetness.",
    price: "IDR 220,000",
    weight: "50g",
    category: "black",
    image: "/images/tea-lapsang.jpg",
    tags: ["Smoked", "Bold"],
  },
  {
    id: "butterfly-pea",
    name: "Butterfly Pea Blend",
    origin: "Bali, Indonesia",
    description: "Local butterfly pea flowers with lemongrass and ginger. Color-changing magic.",
    price: "IDR 160,000",
    weight: "40g",
    category: "herbal",
    image: "/images/tea-butterfly.jpg",
    tags: ["Local", "Caffeine-free"],
  },
];
                      ...
                      {tea.tags && (
                        <div className="flex flex-wrap gap-1.5">
                          {tea.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[10px] tracking-[0.1em] uppercase text-bark/70 border border-bark/15 rounded-full px-3 py-1"
                            >
                              {tag}
                            </span>
                          ))}
